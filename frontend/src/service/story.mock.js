    ...
    scenes: [
      ...
      },
      {
        ...
        dialogues: [
          ...
          {
            narration: '界面顶端赫然写着几个大字：【仙道酬勤·充值就变强系统】。',
            playerChoices: null
          }
        ],
        isChapterEnding: false
            ...
            playerChoices: [
              {
                ...
                statusesDelta: { 美食家称号: '新晋美食家' },
                subsequentDialogues: [
                  '当晚，云舒的小摊在回宿舍的路上支了起来。诱人的香气瞬间吸引了不少弟子。',
                  '第一天下来，成本收回，还净赚了三十块灵石！'
                ]
              },
              {
                id: 'opt_B',
            ...
            playerChoices: [
              {
                ...
                statusesDelta: { 预约服务: true },
                subsequentDialogues: [
                  '当晚云舒的小摊在回宿舍的路上支了起来。诱人的香气瞬间吸引了不少弟子。',
                  '第一天下来，成本收回，还净赚了三十块灵石！'
                ]
              },
              {
