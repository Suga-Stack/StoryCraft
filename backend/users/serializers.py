...
from .models import CommentReport, CreditLog, GameworkReport
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        user = User.objects.create(
            username=validated_data["username"], email=email, password=make_password(password), is_staff=False
        )
        return user
...
class LoginSerializer(serializers.Serializer):
    ...
    def get_tokens_for_user(self, user):
        ...
        return {"access": str(refresh.access_token), "refresh": str(refresh), "user": user_data}
