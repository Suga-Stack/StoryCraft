...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        music_data = [
            ...
            {"filename": "golden-waves-432hz-219189.mp3", "tags": ["末世", "废土", "暗黑", "虐心"]},
            {
            ...
            {"filename": "amalgam-217007.mp3", "tags": ["科幻", "都市", "星际", "赛博朋克", "蒸汽朋克"]},
            {
            ...
            {"filename": "sweet-life-luxury-chill-438146.mp3", "tags": ["都市", "赛博朋克", "蒸汽朋克"]},
            {"filename": "please-calm-my-mind-125566.mp3", "tags": ["奇幻", "暗黑", "虐心", "烧脑", "智斗", "热血"]},
            {"filename": "inspiring-cinematic-ambient-116199.mp3", "tags": ["悬疑", "惊悚", "灵异", "烧脑"]},
            {
        ...
        for item in music_data:
            ...
            music, created = Music.objects.get_or_create(url=full_url)
