...
from .models import Comment, Favorite, FavoriteFolder, Rating
...
class FavoriteSerializer(serializers.ModelSerializer):
    ...
    folder = serializers.PrimaryKeyRelatedField(queryset=FavoriteFolder.objects.all(), allow_null=True, required=False)
    ...
    def create(self, validated_data):
        ...
        favorite, created = Favorite.objects.get_or_create(user=user, gamework=gamework, defaults={"folder": folder})
        if not created:
...
class RatingSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        rating, created = Rating.objects.update_or_create(user=user, gamework=gamework, defaults={"score": score})
        return rating
